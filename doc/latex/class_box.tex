...
Constructor receiving object\textquotesingle{}s position, size and orientation. 

Initializes the position, size and orientation with parameters received and other member variables with the default values for box objects. The orientation can be omitted in the instantiation of the object.
